// <copyright file="Util.cs" company="Microsoft Open Technologies, Inc.">
...
namespace YmatouMQServerConsoleApp.owin
{
    public static class Util
    {
        ...
        public static MessageDto ToMessageDto(this IDictionary<string, object> env)
        {
            return new MessageDto
            {
                AppId = env["appid"].ToString(),
                Code = env["code"].ToString(),
                Body = env["body"],
                Ip = env["ip"].ToString(),
                MsgUniqueId = env["msguniqueid"].ToString()
            };
        }
    }
}
