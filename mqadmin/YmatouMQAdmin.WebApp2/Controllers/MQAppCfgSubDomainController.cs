        ...
        public IEnumerable<MQMainConfiguration> Get()
        {
            ...
            try
            {
                ...
                allCfg.EachAction(cfg =>
                {
                    ...
                    cfg.MessageCfgList.EachAction(m => msgTmp.Add(new MessageConfiguration { Code = m.Code, Enable = m.Enable }));
