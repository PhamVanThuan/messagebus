...
namespace YmatouMQ.ClientNet45
{
    public class MessageBusClientCfg
    {
        ...
        private Dictionary<string, object> cfgDic { get; set; }
    ...
    public class AppCfgInfo2
    {
        ...
        public const string RequestContextType_Json = "application/json;charset=UTF-8";
        ...
        {
            {default_primary_bushost,"http://api.mq.ymatou.com:2345"},
